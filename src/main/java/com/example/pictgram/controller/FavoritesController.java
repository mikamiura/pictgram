...
public class FavoritesController {
    ...
    @GetMapping("/favorites")// /favarites の呼び出しで index メソッドはお気に入り一覧画面を表示
    ...
    @PostMapping("/favorite")// POST メソッドで呼び出されると、お気に入りを登録
    ...
    @DeleteMapping("/favorite")// DELETE メソッドで呼び出されると、お気に入りを削除
    @Transactional
